...
const PersonalInfo = ({ isOpen, onClose }: Props) => (
  <ConfirmDialog
    ...
    message={`디케이메디인포(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.
    ...
    - 개인정보를 제공받는 자 : 에임호, 네이버클라우드, 아임웹
    - 제공받는 자의 개인정보 이용목적 : 간호정보프로그램 개발
    - 제공하는 개인정보 항목 : 성명, 주소, 전화번호, 이메일주소, 카드결제계좌정보
    - 제공받는 자의 보유, 이용기간 : 프로그램 사용 기간
    ...
    - 위탁받는 자 (수탁자) : 아임웹, 에임호, 네이버클라우드
    - 위탁하는 업무의 내용 : 제품 개발 관련
    ...
    필수항목 : 성명, 생년월일, 아이디, 비밀번호, 주소, 전화번호, 성별, 이메일주소, 아이핀번호, 대학, 학번, 전공
    
    선택항목 : 결혼 여부, 관심 분야
    
    2. 재화 또는 서비스 제공
    
    필수항목 : 성명, 생년월일, 아이디, 비밀번호, 주소, 전화번호, 이메일주소, 아이핀번호, 신용카드번호, 은행계좌정보 등 결제정보, 대학, 학번, 전공
    ...
    연락처 : alex.dk.lee@smartnurse.co.kr
    ...
    이 개인정보 처리방침은 2021. 8. 15부터 적용됩니다.`}
    onClose={onClose}
  />
);
