...
function Main() {
  ...
  const NextButton = (
    <button onClick={() => setActivateNumber(activatedNumber + 1)}>Next</button>
  );
    ...
    },
    {
      ...
      component: (
        <Stack direction="row" spacing={0.5} alignItems="center">
          ...
          <Typography>인수인계를 위한 간단한</Typography>
          <Typography sx={{ color: `${palette.primary.main}` }}>
            메모는
          </Typography>
          <Typography>이곳에!</Typography>
          {NextButton}
        </Stack>
      ),
      reference: ref4,
    ...
    <>
      ...
      <Box display="flex" minWidth={1440}>
        <MenuDrawer
          ...
          coachRefB={ref3}
        />
        <DisplayInformation menuDrawerWidth={menuDrawerWidth} coachRef={ref1} />
