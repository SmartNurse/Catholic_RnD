    ...
    switch (type) {
      ...
      case MENU.NURSE_CHECKLIST_ROOM:
        getCheckListRoom({ user_id, patient_id })
          .then(({ data }) => {
            const { nursing_check_list_ward } = data;

            convertDataToStates(
              {
                info_info01: nursing_check_list_ward?.info_info01,
                info_info02: nursing_check_list_ward?.info_info02,
                info_info03: nursing_check_list_ward?.info_info03,

                info_mental01: nursing_check_list_ward?.info_mental01,

                fall01: nursing_check_list_ward?.fall01,
                fall02: nursing_check_list_ward?.fall02,
                fall03: nursing_check_list_ward?.fall03,
                fall04: nursing_check_list_ward?.fall04,
                fall05: nursing_check_list_ward?.fall05,

                bed_sore01: nursing_check_list_ward?.bed_sore01,
                bed_sore02: nursing_check_list_ward?.bed_sore02,
                bed_sore03: nursing_check_list_ward?.bed_sore03,
                bed_sore04: nursing_check_list_ward?.bed_sore04,
                bed_sore05: nursing_check_list_ward?.bed_sore05,

                edu01: nursing_check_list_ward?.edu01,
                edu02: nursing_check_list_ward?.edu02,

                care_plan01: nursing_check_list_ward?.care_plan01,
                care_plan02: nursing_check_list_ward?.care_plan02,
                care_plan03: nursing_check_list_ward?.care_plan03,

                surgery01: nursing_check_list_ward?.surgery01,
                surgery02: nursing_check_list_ward?.surgery02,
                surgery03: nursing_check_list_ward?.surgery03,

                medicine01: nursing_check_list_ward?.medicine01,
                medicine02: nursing_check_list_ward?.medicine02,

                hospitalization01: nursing_check_list_ward?.hospitalization01,
                hospitalization02: nursing_check_list_ward?.hospitalization02,
                hospitalization03: nursing_check_list_ward?.hospitalization03,
                hospitalization04: nursing_check_list_ward?.hospitalization04,
                hospitalization05: nursing_check_list_ward?.hospitalization05,
                hospitalization06: nursing_check_list_ward?.hospitalization06,
                hospitalization07: nursing_check_list_ward?.hospitalization07,
                hospitalization08: nursing_check_list_ward?.hospitalization08,

                ns_fall01: nursing_check_list_ward?.ns_fall01,
                ns_fall02: nursing_check_list_ward?.ns_fall02,

                ns_bedsore01: nursing_check_list_ward?.ns_bedsore01,

                ns_pt_moving01: nursing_check_list_ward?.ns_pt_moving01,
                ns_pt_moving02: nursing_check_list_ward?.ns_pt_moving02,

                ns_edu01: nursing_check_list_ward?.ns_edu01,

                ns_surgery01: nursing_check_list_ward?.ns_surgery01,

                ns_transfusion01: nursing_check_list_ward?.ns_transfusion01,

                ns_infection01: nursing_check_list_ward?.ns_infection01,

                ns_pain01: nursing_check_list_ward?.ns_pain01,
                ns_pain02: nursing_check_list_ward?.ns_pain02,
                ns_pain03: nursing_check_list_ward?.ns_pain03,

                ns_re_pain01: nursing_check_list_ward?.ns_re_pain01,
                ns_re_pain02: nursing_check_list_ward?.ns_re_pain02,
                ns_re_pain03: nursing_check_list_ward?.ns_re_pain03,
                ns_re_pain04: nursing_check_list_ward?.ns_re_pain04,

                ns_pca01: nursing_check_list_ward?.ns_pca01,
                ns_pca02: nursing_check_list_ward?.ns_pca02,
                ns_pca03: nursing_check_list_ward?.ns_pca03,
                ns_pca04: nursing_check_list_ward?.ns_pca04,

                ns_nausea01: nursing_check_list_ward?.ns_nausea01,
                ns_nausea02: nursing_check_list_ward?.ns_nausea02,

                ns_chemo_side_eff01:
                  nursing_check_list_ward?.ns_chemo_side_eff01,

                ns_restraint01: nursing_check_list_ward?.ns_restraint01,
                ns_restraint02: nursing_check_list_ward?.ns_restraint02,
                ns_restraint03: nursing_check_list_ward?.ns_restraint03,
                ns_restraint04: nursing_check_list_ward?.ns_restraint04,
                ns_restraint05: nursing_check_list_ward?.ns_restraint05,

                ns_high_risk01: nursing_check_list_ward?.ns_high_risk01,
                ns_high_risk02: nursing_check_list_ward?.ns_high_risk02,

                right01: nursing_check_list_ward?.right01,

                discharge01: nursing_check_list_ward?.discharge01,
                discharge02: nursing_check_list_ward?.discharge02,
                discharge03: nursing_check_list_ward?.discharge03,
                discharge04: nursing_check_list_ward?.discharge04,

                ocs01: nursing_check_list_ward?.ocs01,
              },
              initialCheckListRoom
            );
          })
