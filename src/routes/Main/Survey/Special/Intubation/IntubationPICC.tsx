...
const IntubationPICC = (props: Props) => {
  ...
  const labels = ['종류', '삽입 부위', '피부 및 삽입 상태', '드레싱 종류'];
  const registerIds = [
    'volume',
    'blood_flow',
    'arterial_pressure',
  ...
  return (
    <>
      <SectionTitle title="PICC, C-line, A-line, AVF, HD catheter " />
      <RowContainer xs={12}>
        <Grid item flex={1}>
                  ...
                  .map((_, idx) => (
                    <TableCell key={idx}>
                      <Form.MuiTextField
                        ...
                        // {...register(`${time}`)}
                      >
                        <MenuItem key={1} value={'PICC'}>
                          PICC
                        </MenuItem>
                        <MenuItem key={2} value={'C-line'}>
                          C-line
                        </MenuItem>
                        <MenuItem key={3} value={'A-line'}>
                          A-line
                        </MenuItem>
                        <MenuItem key={4} value={'AVF'}>
                          AVF
                        </MenuItem>
                        <MenuItem key={5} value={'HD catheter'}>
                          HD catheter
                        </MenuItem>
                      </Form.MuiTextField>
                    </TableCell>
