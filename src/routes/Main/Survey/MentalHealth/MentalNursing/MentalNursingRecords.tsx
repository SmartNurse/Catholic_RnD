...
import { Button, Grid, IconButton, Table, TableBody, TableCell, TableRow, Typography } from '@mui/material';
      ...
      <Grid item xs={12}>
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          ...
          <TableBody>
            {displayRows.map((row) => (
              <>
                <TableRow key="일시" sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                  <TableCell style={{ width: "20%", verticalAlign: "top" }}>일시</TableCell>
                  <TableCell>
                    <Typography style={{ fontSize: "14px" }}>{row.date}</Typography>
                  </TableCell>
                  <TableCell>
                    <Typography style={{ fontSize: "14px" }}>{row.time}</Typography>
                  </TableCell>
                  <TableCell align="right">
                    {row.action}
                  </TableCell>
                ...
                <TableRow key="평가" sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                  <TableCell style={{ width: "20%", verticalAlign: "top" }}>평가</TableCell>
                  <TableCell colSpan={3}>
                    <Typography style={{ fontSize: "14px" }}>{row.evaluation}</Typography>
                  </TableCell>
                </TableRow>
