...
const contents = [
  ...
  '검사 후 남은 검사대상물을 인체유래물연구 또는 허가받은 인체유래물은행에 기증하는 것에 동의하는 경우에는 연구의 목적, 개인정보의 제공에 관한 사항 등 제공에 관한 구체적인 설명을 충분히 듣고, 별지 제34호의 인체유래물연구\n    동의서 또는 별지 제41호의 인체유래물등의 기증동의서를 추가로 작성하여야합니다. ',
];
