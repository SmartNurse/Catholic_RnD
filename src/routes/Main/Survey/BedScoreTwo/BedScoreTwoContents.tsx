      ...
      toolTipContents: [
        {
          title: '완전제한',
          contents:
            '의식이 저하되거나 진정제로 인해 통증자극에 대해 전혀 반응이 없음 즉 신음이 움찔거리거나 손을 쥐지 않음 또는 신체의 대부분에 감각이 떨어짐',
        },
        {
          title: '매우제한',
          contents:
            '통증자극에만 반응하고 신음하거나 안절부절 못하는 것 외에는 불편감을 호소하지 못함 또는 신체의 1/2 이상의 감각이 떨어짐',
        },
        {
          title: '약간제한',
          contents:
            '언어적 지시에 반응은 보이나 항상 불편감에 대한 의사소통을 보이지는 않음 또는 1개 또는 2개 사지의 감각이 떨어짐',
        },
        {
          title: '장애없음',
      ...
      toolTipContents: [
        {
          title: '지속적으로 습함',
          contents:
            '땀, 소변 등으로 피부가 계속 습한 상태임. 환자를 이동하거나 돌려 눕힐 때 항상 축축하게 전혀 있는 것을 볼 수 있음. 기저귀를 매일 착용하고 교환해줘야 함',
        },
        {
          title: '습함',
          contents:
    ...
    },
    {
      ...
      toolTipContents: [
        ...
        },
        {
          title: '의자에 앉을 수 있음',
          contents:
            '보행능력이 없거나 매우 제한됨. 몸을 지탱할 수 없거나 의자나 휠체어로 옮길 때 도움이 필요로 함',
        },
        {
          title: '때때로보행',
          contents:
            '낮 동안은 때때로 걸으나 짧은 거리만 가능함. \n대부분을 침대나 의자에서 보냄',
        },
        {
          title: '정상',
    ...
    },
    {
      ...
      toolTipContents: [
        ...
        },
        {
          title: '매우제한',
          contents:
            '가끔 신체나 사지를 움직일 수 있으나 혼자서 자주 하지는 않음',
        },
        {
          title: '약간제한',
      ...
      toolTipContents: [
        {
          title: '불량',
          contents:
            '식사의 1/3 이상을 섭취하지 못하고 수분섭취도 부족함. \n금식 중이거나 수액치료 중임',
        },
        {
          title: '부적절함',
          contents:
      ...
      toolTipContents: [
        {
          title: '문제있음',
          contents:
            '이동시 많은 도움을 필요로 하며 끌지 않고 완전히 옮기기 불가능함. 종종 침대나 의자에게 미끄러져 자세를 다시 취해야 함. 경직, 경축, 초조가 계속적으로 마찰을 일으킴',
        },
        {
          title: '잠재적문제있음',
          contents:
            '최소한의 도움을 받아 움직일 수 있음. 이동시 시트, 의자, 억제대나 다른 도구에 약간 끌림. 때때로 미끄러지나 의자나 침대에서 대부분은 좋은 자세를 유지함',
        },
        {
          title: '문제없음',
          contents:
            '침대나 의자에서 혼자 움직일 수 있고 움직이는 동안은 몸을 들어 올릴 수 있음. 침대나 의자에서 좋은 자세를 유지할 수 있음',
        },
      ],
      ...radioGroup({
          ...
          >
            ...
            <div style={{ display: 'flex' }}>
              <Typography variant="inherit" sx={{ marginLeft: '15px' }}>
                <Question style={{ blockSize: '14px' }} /> 클릭하여 상세 설명을
                확인할 수 있습니다.
              </Typography>
            </div>
            <Typography variant="inherit" sx={{ marginLeft: '30px' }}>
