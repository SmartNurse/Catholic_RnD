...
const contentLabel = [
    ...
    },
    {
        id: 2,
        ko: "언어 반응\n(Verbal Response)",
        desc: ["전혀 소리를 내지 못한다", "이해할 수 없는 소리, 신음소리를 낸다", "말은 하되, 부적절한 언어를 사용한다", "지남력(사람/장소/시간)의 하나 이상 영역을 상실하고 혼돈되어있다", "지남력(사람/장소/시간)에 대해 인지한다"],
    },
    {
        id: 3,
        ko: "운동 반응\n(Motor Response)",
        desc: ["전혀 반응이 없다", "통증을 가하면 비정상적인 신전 반응이 있다", "통증을 가하면 비정상적인 굴곡 반응이 있다", "자극에 몸을 구부려 움츠린다", "명령에 따르지 못하나 통증 부위의 자극을 제거하려고 한다", "명령에 반응하여 그대로 실시한다" ],
    }
];
const scoreLabel = [
