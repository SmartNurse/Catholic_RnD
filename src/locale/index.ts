const locale = {
  ko: {
    ...
    'REQUIRED.PASSWORD.CONFIRMTWO': '새 비밀번호 확인을 입력해주세요',
    ...
    // bedScore I
    'BED.SCORE.SENSORY.PERCEPTION.1': '전혀 못 느낌',
    'BED.SCORE.SENSORY.PERCEPTION.2': '매우 제한됨',
    'BED.SCORE.SENSORY.PERCEPTION.3': '약간 제한됨',
    'BED.SCORE.SENSORY.PERCEPTION.4': '제한 없음',
    'BED.SCORE.HUMIDITY.1': '항상 젖어 있음',
    'BED.SCORE.HUMIDITY.2': '자주 젖어 있음',
    'BED.SCORE.HUMIDITY.3': '약간 젖어 있음',
    'BED.SCORE.HUMIDITY.4': '거의 젖어 있지 않음',
    'BED.SCORE.ACTIVITY.1': '침대에 국한됨',
    'BED.SCORE.ACTIVITY.2': '침대에 의존함',
    'BED.SCORE.ACTIVITY.3': '가끔 걸음',
    'BED.SCORE.ACTIVITY.4': '걸어다님',
    'BED.SCORE.MOBILITY.1': '전혀 못 움직임',
    'BED.SCORE.MOBILITY.2': '매우 제한됨',
    'BED.SCORE.MOBILITY.3': '약간 제한됨',
    'BED.SCORE.MOBILITY.4': '자유로움',
    'BED.SCORE.NUTRITION.1': '매우 나쁨',
    'BED.SCORE.NUTRITION.2': '부족한 섭취',
    'BED.SCORE.NUTRITION.3': '적당한 섭취 또는 TPN 주입',
    'BED.SCORE.NUTRITION.4': '좋음',
    'BED.SCORE.FRICTION.1': '문제 있음',
    'BED.SCORE.FRICTION.2': '잠정적 문제',
    ...
    'SAFETY.OTHER.TYPE.1': '수혈',
    'SAFETY.OTHER.TYPE.2': '검사 관련',
    'SAFETY.OTHER.TYPE.3': '화상',
    'SAFETY.OTHER.TYPE.4': '자해, 자살',
