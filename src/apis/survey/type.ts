...
export interface IUpdateCPR extends IGetSurvey {
  catholic_cpr_survey: {
    ...
    treatment: {
      ...
      artificial_ventilation0: boolean;
      aed0: string;
      chest_compression1: string;
      artificial_ventilation1: boolean;
      aed1: string;
      chest_compression2: string;
      artificial_ventilation2: boolean;
      aed2: string;
      chest_compression3: string;
      artificial_ventilation3: boolean;
      aed3: string;
      chest_compression4: string;
      artificial_ventilation4: boolean;
      aed4: string;
      chest_compression5: string;
      artificial_ventilation5: boolean;
      aed5: string;
      chest_compression6: string;
      artificial_ventilation6: boolean;
      aed6: string;
      chest_compression7: string;
      artificial_ventilation7: boolean;
      aed7: string;
      chest_compression8: string;
      artificial_ventilation8: boolean;
      aed8: string;
      chest_compression9: string;
      artificial_ventilation9: boolean;
      aed9: string;
      chest_compression10: string;
      artificial_ventilation10: boolean;
      aed10: string;
      chest_compression11: string;
      artificial_ventilation11: boolean;
      aed11: string;
      chest_compression12: string;
      artificial_ventilation12: boolean;
      aed12: string;
      chest_compression13: string;
      artificial_ventilation13: boolean;
      aed13: string;
      chest_compression14: string;
      artificial_ventilation14: boolean;
      aed14: string;
      chest_compression15: string;
      artificial_ventilation15: boolean;
      aed15: string;
      chest_compression16: string;
      artificial_ventilation16: boolean;
      aed16: string;
      chest_compression17: string;
      artificial_ventilation17: boolean;
      aed17: string;
      chest_compression18: string;
      artificial_ventilation18: boolean;
      aed18: string;
      chest_compression19: string;
      artificial_ventilation19: boolean;
      aed19: string;
      chest_compression20: string;
      artificial_ventilation20: boolean;
      aed20: string;
      chest_compression21: string;
      artificial_ventilation21: boolean;
      aed21: string;
    };
    intubation: {
      id0: string;
